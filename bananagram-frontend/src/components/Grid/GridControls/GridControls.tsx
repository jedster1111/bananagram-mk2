  ...
  <GridControlsWrapper>
    <ControlButtonsWrapper>
      ...
      <Button onClick={onSave}>
        Save{'('}
        {`${offset.x}, ${offset.y}@${dimensions.x}x${dimensions.y})`}
      </Button>
      <Button onClick={onHome}>
        Home{'('}
        {`${initialOffset.x}, ${initialOffset.y}@${initialGridDimensions.x}x${initialGridDimensions.y})`}
      </Button>
      <Button onClick={onRestore}>
        Restore{'('}
        {`${offsetSaved.x}, ${offsetSaved.y}@${dimensionsSaved.x}x${dimensionsSaved.y})`}
      </Button>
